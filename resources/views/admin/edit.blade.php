<x-layout-admin>
    <div class="">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('users.edit', $user->id) }}"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">Edit Users</a>
                    </div>
                </li>
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                <label for="password" class="block text-gray-700 text-sm font-bold mb-2">Password (optional)</label>
                <input type="password" id="password" name="password" 
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                <small class="text-gray-500">Kosongkan Jika Tidak Ganti Password</small>
            </div>
